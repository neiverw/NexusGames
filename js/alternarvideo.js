...
const cameraUnlockedIcon = "imagenes/icons/PepiconsPopCamera.png"; // Icono cuando el video está activo
const cameraLockedIcon = "imagenes/icons/PepiconsPopCameraOff.png"; // Icono cuando la imagen está activa
const soundOnIcon = "imagenes/icons/CharmSoundUp.png"; // Icono cuando el sonido está activado
const soundOffIcon = "imagenes/icons/CharmSoundMute.png"; // Icono cuando el sonido está desactivado
